...
global password_from_db, Incorrect_login_or_password, Correct_login_or_password, scr, scr_2, d2, science_work_is_ok, scr_3, all_inf, number_page_invitation, user_name, new_file, all_inf, main_total_back_to_start
...
def main_start():
    ...
    def task1():
        ...
        def text_handler(message):
            if message.text == '/start':
                ...
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                bot.delete_message(d2[f'{user_name}']
                ...
                def clear_chat(message):
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], user_is_not_found_co.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], time_1.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], send_is_ok.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], total_back_4.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], work_is_ok.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], local2.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], message.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                    ...
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], not_db.message_id)
                            break
                        except BaseException:
                            break
                    while True:
                        try:
                            ...
                            while local6 != 30:
                                ...
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], number_id)
                                number_id -= 1
                                local6 += 1
                            break
                        except BaseException:
                ...
                try:
                    ...
                    if d2[f'{user_name}']['start_message_bool'] == 'False':
                        ...
                        while True:
                            try:
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], what_email.message_id)
                                break
                            except BaseException:
                                break
                        while True:
                            try:
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], total_back_message.message_id)
                                break
                            except BaseException:
                                break
                        while True:
                        ...
                        while True:
                            try:
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], full_information.message_id)
                                break
                            except BaseException:
                                break
                        while True:
                            try:
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], refund.message_id)
                                break
                            except BaseException:
                                break
                        ...
                        while True:
                            try:
                                if message_to_delete_to_main_menu == 'Incorrect_login_or_password':
                                    ...
                                    bot.delete_message(
                                        d2[f'{user_name}']['chat_id'], Prohibited_character.message_id)
                                elif message_to_delete_to_main_menu == '/back':
                                    bot.delete_message(
                                        d2[f'{user_name}']['chat_id'], bake_to_start.message_id)
                                break
                            except BaseException:
                                break

                        bot.register_next_step_handler(
                            message, choice, start_message, choice_message, bot)
                        break
        ...
        def main_menu_for_user(message):
            ...
            while True:
                try:
                    with connection.cursor() as cursor:
                        insert_querty_1_co = f"""SELECT * FROM login_and_password WHERE login='{
                            login}' and password ='{password.text}'"""
            ...
            btn2 = types.KeyboardButton(
                'Отправленные работы(просмотреть\\редактировать)')
            ...
            while True:
                try:
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], you_have_not_works.message_id)
                    break
                except BaseException:
                    break
            while True:
                try:
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], total_back_155.message_id)
                    break
                except BaseException:
                    break
            ...
            if message_to_delete_to_main_menu == 'Correct_login_or_password':
                bot.delete_message(
                    d2[f'{user_name}']['chat_id'], Correct_login_or_password.message_id)
                message_to_delete_to_main_menu = ''

            bot.register_next_step_handler(
                message, main_menu_check, choice_message)
        ...
        def main_menu_check(message, choice_message):
            ...
            while True:
                try:
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], choice_message.message_id)
                    break
                except BaseException:
                    break
            ...
            if message.text == 'Загрузить научную работу':
                def expert_opinion(message):
                    ...
                    def local_function(message, expert_opinion_message):
                        ...
                        if str(user_name) == 'None':
                            user_name = message.from_user.first_name
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], expert_opinion_message.message_id)
                            ...
                            try:
                                ...
                                while True:
                                    try:
                                        ...
                                        v = {
                                            'file_name_for_last_letter': f'{file_name_for_last_letter}'}
                                        user_name = message.from_user.username
                                        if str(user_name) == 'None':
                                            user_name = message.from_user.first_name
                                        d2[f'{user_name}'].update(v)
                                        ...
                                        break
                                last_letter = d2[f'{
                                    user_name}']['file_name_for_last_letter']
                                ...
                                if last_letter == 'f':  # pdf файл
                                    src = 'main.py/expert_opinions' + \
                                        f'/Экспертное заключение {
                                            random_number}.pdf'
                                with open(src, 'wb') as new_file:
                                    new_file.write(downloaded_file)
                                expert_opinion_from_user = convert_to_Binary(f'{
                                                                             src}')
                                v = {
                                    'expert_opinion_from_user': f'{expert_opinion_from_user}'}
                                user_name = message.from_user.username
                                if str(user_name) == 'None':
                                    user_name = message.from_user.first_name
                                d2[f'{user_name}'].update(v)
                                ...
                                if str(user_name) == 'None':
                                    user_name = message.from_user.first_name
                                d2[f'{user_name}'].update(v)
                                file_uploaded_successfully = bot.reply_to(
                                    message, "Файл успешно загружен")
                                time.sleep(2)
                                bot.delete_message(
                                    d2[f'{user_name}']['chat_id'], message.message_id)
                                new_file.close()
                                upload_a_scientific_work(
                    ...
                    bot.register_next_step_handler(
                        message, local_function, expert_opinion_message)

                def upload_a_scientific_work(
                        message, file_uploaded_successfully):
                    global upload
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], file_uploaded_successfully.message_id)
                            break
                        except BaseException:
                            break
                ...
                def work_name(message):
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], message.message_id)
                    bot.register_next_step_handler(
                        message, section_selection, enter_work_name)
                ...
                def section_selection(message, enter_work_name):
                    ...
                    v = {'the_name_of_the_scientific_work': f'{
                        the_name_of_the_scientific_work}'}
                    user_name = message.from_user.username
                    if str(user_name) == 'None':
                        user_name = message.from_user.first_name
                    d2[f'{user_name}'].update(v)
                    ...
                    def section_selection_check_choice(message):
                        if message.text == 'Пленарная секция':
                            ...
                            v = {
                                'section_of_the_work': f'{section_of_the_work}'}
                            user_name = message.from_user.username
                            if str(user_name) == 'None':
                                user_name = message.from_user.first_name
                            d2[f'{user_name}'].update(v)
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], sect.message_id)
                            print('vvv')
                    ...
                    sections = types.ReplyKeyboardMarkup(
                        resize_keyboard=True, one_time_keyboard=True)
                    ...
                    while True:
                        try:
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], enter_work_name.message_id)
                            break
                        except BaseException:
                            break

                    bot.register_next_step_handler(
                        message, section_selection_check_choice)
                ...
                def submitted_works2():
                    def submitted_works():
                        ...
                        def submitted_works_check_choice(message):
                            if message.text == 'Предыдущая работа':
                                global kol, change, block
                                change = True
                                ...
                                def submitted_works_check_choic(message):
                                    if message.text == 'Добавить соавтора':
                                        def add_co_author_check(message):
                                            ...
                                            with connection.cursor() as cursor:
                                                insert_querty_1_co = f"""SELECT * FROM login_and_password WHERE email='{
                                                    email_from_user_co}'"""
                                                cursor.execute(
                                                    insert_querty_1_co)
                                                ...
                                                def localdef(message):
                                                            ...
                                                            while True:
                                                                try:
                                                                    with connection.cursor() as cursor_5:
                                                                        wait_1_co = f"""SELECT email_waiting_users FROM waiting_for_registration WHERE email_waiting_users='{email}' and id_waiting_users ='{
                                                                            unical_id_from_login_and_password_db}' and email_for_registration='{email_from_user_co}' and expected_user_status = 'Соавтор'"""
                                                                        cursor_5.execute(
                                                                            wait_1_co)
                                                                        try:
                                                                            v_co = cursor_5.fetchall()[
                                                                                0]
                                                    ...
                                                    bot.register_next_step_handler(
                                                        message, localdef_choice_check4)

                                                while True:
                                                    try:
                                                        all_from_db = cursor.fetchall()[
                                                            0]
                                                        with connection.cursor() as cursor_5:
                                                            wait_1_co = f"""SELECT email_waiting_users FROM waiting_for_registration WHERE email_waiting_users='{email}' and id_waiting_users ='{
                                                                unical_id_from_login_and_password_db}' and email_for_registration='{email_from_user_co}' and expected_user_status = 'Соавтор'"""
                                        ...
                                        def add_supervisor_2_check(message):
                                            ...
                                            with connection.cursor() as cursor:
                                                ...
                                                def localdef(message):
                                                        ...
                                                        if message.text == 'Отправить приглашение':
                                                            ...
                                                            while True:
                                                                try:
                                                                    with connection.cursor() as cursor_5:
                                                                        wait_1_co = f"""SELECT email_waiting_users FROM waiting_for_registration WHERE email_waiting_users='{email}' and id_waiting_users ='{
                                                                            unical_id_from_login_and_password_db}' and email_for_registration='{email_from_user_co}' and expected_user_status = 'Научный руководитель'"""
                                                                        cursor_5.execute(
                                                                            wait_1_co)
                                                                        try:
                                                                            v_co = cursor_5.fetchall()[
                                                    ...
                                                    bot.register_next_step_handler(
                                                        message, localdef_choice_check3)
                                        ...
                                        bot.delete_message(d2[f'{user_name}']['chat_id'],
                                                           science_work_is_ok_2.message_id)
                                        bot.register_next_step_handler(
                                            message, add_supervisor_2_check)
                                        ...
                                        try:
                                            ...
                                            with connection.cursor() as cursor_1:
                                                insert_querty = f"""DELETE FROM scientific_work WHERE name_scientific_work = '{
                                                    all_inf['name_scientific_work']}' and unique_id = '{all_inf['unique_id']}'"""
                                ...
                                menu_buttons_3 = types.ReplyKeyboardMarkup(
                                    resize_keyboard=True, one_time_keyboard=True)
                                ...
                                scr_3 = open(scr, 'rb')
                                print('send1')
                                science_work_is_ok_2 = bot.send_document(d2[f'{user_name}']['chat_id'], scr_3,
                                                                         caption=f"Научная работа {
                                    kol + 1}/{
                                    len(kol_inf)}\nФИО: {full_name}\nУниверситет: {university}\nEmail: {email}\nНазвание работы: {
                                    all_inf['name_scientific_work']}\nНаучный руководитель: {
                                    all_inf['supervisor']}\nСоавторы: {
                                    all_inf['co_author']}\nДата публикации: {
                                    all_inf['date_of_publication']}",
                                ...
                                while True:
                                    try:
                                        bot.delete_message(
                                            d2[f'{user_name}']['chat_id'], science_work_is_ok.message_id)
                                        break
                                    except BaseException:
                                        try:
                                            bot.delete_message(d2[f'{user_name}']['chat_id'],
                                            ...
                                            break
                                bot.register_next_step_handler(
                                    message, submitted_works_check_choic)
                        ...
                        menu_buttons_2 = types.ReplyKeyboardMarkup(
                            resize_keyboard=True, one_time_keyboard=True)
                        ...
                        with connection.cursor() as cursor:
                            wait_2 = f"""SELECT unique_id, full_name, university_full, email FROM login_and_password WHERE login='{
                                login}' and password='{password.text}'"""
                        ...
                        with connection.cursor() as cursor_1:
                            wait_1 = f"""SELECT * FROM scientific_work WHERE unique_id='{
                                unique_id_from_db['unique_id']}'"""
                            ...
                            try:
                                ...
                                if name[-1] == 'f':
                                    scr = binary_to_file(all_inf['work'],
                                                         f'main.py/works' + f'/{all_inf["name_scientific_work"]}.pdf')
                                    scr = f'main.py/works' + \
                                        f'/{all_inf["name_scientific_work"]}.pdf'
                                    break
                                else:
                                    scr = binary_to_file(all_inf['work'],
                                                         f'main.py/works' + f'/{all_inf["name_scientific_work"]}.pdf')
                        ...
                        while True:
                            try:
                                if block == False:
                                    ...
                                    if change == False:
                                        print('send2')
                                        science_work_is_ok = bot.send_document(d2[f'{user_name}']['chat_id'], scr_3,
                                                                               caption=f"Научная работа {
                                            kol + 1}/{
                                            len(kol_inf)}\nФИО: {full_name}\nУниверситет: {university}\nEmail: {email}\nНазвание работы: {
                                            all_inf['name_scientific_work']}\nНаучный руководитель: {
                        ...
                        bot.register_next_step_handler(
                            message, submitted_works_check_choice)
                ...
                with connection.cursor() as cursorr:  # проверка всех данных пользователя
                    insert_querty_1_cor = f"""SELECT * FROM login_and_password WHERE login='{
                        login}' and password ='{password.text}'"""
                    ...
                    while True:
                        try:
                            with connection.cursor() as cursor_7:  # проверка есть ли у пользователя приглашения
                                wait_7_co = f"SELECT * FROM waiting_for_registration WHERE email_for_registration='{
                                    email}'"
                            ...
                            print(
                                f'number_page_invitation - {number_page_invitation}')
                            all_info_about = all_all_info[number_page_invitation]
                            print(f'all_info_about - {all_info_about}')

                            def incoming_invitations(
                                    message, all_info_about, all_info_about_user_profile):
                                while True:
                                    try:
                                        bot.delete_message(
                                            d2[f'{user_name}']['chat_id'], inv_is_ok.message_id)
                                        break
                                    except BaseException:
                                        break
                                ...
                                def incoming_invitations_choice_check(message):
                                    if message.text == 'Прошлое приглашение':
                                        ...
                                        while True:
                                            try:
                                                with connection.cursor() as cursor:
                                                    wait_7_co = f"SELECT * FROM login_and_password WHERE email='{
                                                        all_info_about['email_for_registration']}'"
                                                    cursor.execute(wait_7_co)

                                                all_from_log_and_pass = cursor.fetchall()[
                                                    0]
                                                break
                                            except BaseException:
                                                break
                                        ...
                                        while True:
                                            try:
                                                ...
                                                with connection.cursor() as cursor_1:
                                                    wait_7_co = f"SELECT * FROM scientific_work WHERE email='{
                                                        all_info_about['email_waiting_users']}'"
                                                    cursor_1.execute(wait_7_co)

                                                    all_from_log_and_pass = cursor_1.fetchall()[
                                                        0]
                                        ...
                                        if all_info_about['expected_user_status'] == 'Научный руководитель':
                                            if inf_supervisor is not None:
                                                ...
                                                sup_ent = f'{
                                                    all_from_log_and_pass['full_name']}'
                                            with connection.cursor() as cursor_1:
                                                wait_1 = f"UPDATE scientific_work SET supervisor = '{sup_ent}' WHERE unique_id = '{
                                                    all_info_about['id_waiting_users']}' and name_scientific_work = '{
                                                    all_info_about['name_scientific_work']}'"
                                                cursor_1.execute(wait_1)
                                                connection.commit()
                                            ...
                                            with connection.cursor() as cursor_7:
                                                invitation_no_ = f"""DELETE FROM waiting_for_registration WHERE id_waiting_users = '{
                                                    all_info_about['id_waiting_users']}' and name_scientific_work = '{
                                                    all_info_about['name_scientific_work']}' """
                                                cursor_7.execute(
                                                    invitation_no_)
                                            ...
                                            if inf_co_author is not None:
                                                ...
                                                co_ent = f'{
                                                    all_from_log_and_pass['full_name']}'
                                            with connection.cursor() as cursor_1:
                                                wait_1 = f"UPDATE scientific_work SET co_author = '{co_ent}' WHERE unique_id = '{
                                                    all_info_about['id_waiting_users']}' and name_scientific_work = '{
                                                    all_info_about['name_scientific_work']}'"
                                                cursor_1.execute(wait_1)
                                                connection.commit()
                                            ...
                                            with connection.cursor() as cursor_77:
                                                invitation_no_1 = f"""DELETE FROM waiting_for_registration WHERE id_waiting_users = '{
                                                    all_info_about['id_waiting_users']}' and name_scientific_work = '{
                                                    all_info_about['name_scientific_work']}' """
                                                cursor_77.execute(
                                                    invitation_no_1)
                                        ...
                                        while True:
                                            try:
                                                print(
                                                    all_info_about_user_profile['unique_id'])
                                                print(
                                                    all_info_about['name_scientific_work'])
                                                with connection.cursor() as cursor_7:
                                                    invitation_no = f"""DELETE FROM waiting_for_registration WHERE id_waiting_users = '{
                                                        all_info_about['id_waiting_users']}' and name_scientific_work = '{
                                                        all_info_about['name_scientific_work']}' """
                                                    cursor_7.execute(
                                                        invitation_no)
                                        ...
                                        time.sleep(1)
                                        bot.delete_message(
                                            d2[f'{user_name}']['chat_id'], invitation_text.message_id)
                                        while True:
                                            try:
                                                bot.delete_message(d2[f'{user_name}']['chat_id'],
                                ...
                                invitation_text = bot.send_message(d2[f'{user_name}']['chat_id'],
                                    ...
                                    all_info_about['name_scientific_work']}\nВы приглашены в роли: {
                                    all_info_about['expected_user_status']}',
                                ...
                                bot.register_next_step_handler(
                                    message, incoming_invitations_choice_check)
        ...
        def file_check(message):
            while True:
                try:
                    ...
                    def convert_to_Binary(filename):
                        global file_uploaded_successfully
                        with open(filename, 'rb') as file:
                            binarydata = file.read()
                            file.close()
                            return binarydata
                    ...
                    while True:
                        try:
                            ...
                            if last_letter == 'f':  # pdf файл
                                src = 'main.py/works' + \
                                    f'/Научная работа {random_number}.pdf'
                                src_2 = src
                            elif last_letter == 'x':  # docx файл
                                src = 'main.py/works' + \
                                    f'/Научная работа {random_number}.docx'
                                src_2 = src
                            v = {'src': f'{src}'}
                            user_name = message.from_user.username
                            if str(user_name) == 'None':
                            ...
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], message.message_id)
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], upload.message_id)
                    ...
                    work_for_exemple = convert_to_Binary(f'{src}')
                    print('file check 5')
                    ...
                    with connection.cursor() as cursor:
                        ...
                        while True:
                            try:
                                ...
                                bot.send_message(
                                    d2[f'{user_name}']['chat_id'], 'Ошибка №114\nОбратитесь в поддержку')
                                break
                    ...
                    def file_check_choice_check(message):
                        if message.text == 'Отправить на оценивание':
                            ...
                            with connection.cursor() as cursor_1:
                                ...
                                value = (
                                    a['unique_id'], {
                                        d2[f'{user_name}']['full_name']},
                                    {d2[f'{user_name}']['university']},
                                    {d2[f'{user_name}']['email']},
                                    {d2[f'{user_name}']
                                        ['the_name_of_the_scientific_work']},
                                    os.path.basename(new_file.name), {
                                        d2[f'{user_name}']['date_of_publication']},
                                    {d2[f'{user_name}']['work_for_exemple']},
                                    {d2[f'{user_name}']
                                        ['expert_opinion_from_user']},
                            ...
                            work_is_ok = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                          ...
                                                          reply_markup=None)
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], scientific_work_report.message_id)

                            dir = 'main.py/works'  # Удаление работ
                            ...
                            def add_a_supervisor_check(message):
                                ...
                                with connection.cursor() as cursor:
                                    ...
                                    def total_back_from_invitation_to_supervisor_1(
                                            call):
                                        global time_1
                                        time_1_co = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                                     'Возвращаем вас раздел редактирования')
                                        ...
                                        time.sleep(3)
                                        bot.delete_message(
                                            d2[f'{user_name}']['chat_id'], time_1_co.message_id)
                                        file_check(message)
                                    ...
                                    def localdef(message):
                                        ...
                                        bot.register_next_step_handler(
                                            message, localdef_choice_check_2)
                            ...
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], scientific_work_report.message_id)
                            bot.register_next_step_handler(
                                message, add_a_supervisor_check)
                    ...
                    with connection.cursor() as cursor:
                        insert_querty_1 = f"""SELECT unique_id FROM login_and_password WHERE login='{
                            login}' and password='{password.text}'"""
                        cursor.execute(insert_querty_1)
                        a = cursor.fetchall()[0]

                    with connection.cursor() as cursor:
                        all = f"SELECT full_name, university_full, email FROM login_and_password WHERE unique_id = '{
                            a['unique_id']}'"
                        cursor.execute(all)
                        b = cursor.fetchall()[0]
                    scr = open(src, 'rb')
                    ...
                    is_work_alright = types.ReplyKeyboardMarkup(
                        resize_keyboard=True, one_time_keyboard=True)
                    ...
                    bot.register_next_step_handler(
                        message, file_check_choice_check)
                    break
                except BaseException:
                    break
        ...
        def choice(message, start_message, choice_message, bot):
            ...
            if str(user_name) == 'None':
                user_name = message.from_user.first_name
            bot.delete_message(d2[f'{user_name}']
                               ['chat_id'], start_message.message_id)
            bot.delete_message(d2[f'{user_name}']
                               ['chat_id'], choice_message.message_id)
        ...
        def registration(message, bot):
            ...
            def login_request(message):
                ...
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                what_login = bot.send_message(
                    d2[f'{user_name}']['chat_id'], 'Придумайте логин:')
                v = {'start_message_bool': 'False'}
                user_name = message.from_user.username
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                ...
                while True:
                    try:
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], request_to_registration.message_id)
                        break
                    except BaseException:
                        break
                while True:
                    try:
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], login_no.message_id)
                        break
                    except BaseException:
                        break
                while True:
                ...
                bot.register_next_step_handler(
                    message, login_entry, what_login)
            ...
            def login_entry(message, what_login):
                ...
                if message.text == '/error':
                    ...
                    time.sleep(3)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_login.message_id)
                    start(message)
                    ...
                    d2[f'{user_name}'].update(v)
                    with connection.cursor() as cursor:
                        unique_id_local = f"SELECT unique_id FROM login_and_password WHERE login='{
                            login}'"
            ...
            def password_request(message):
                ...
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                what_password = bot.send_message(
                    d2[f'{user_name}']['chat_id'], 'Придумайте пароль:')
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, password_entry, what_password)
            ...
            def password_entry(message, what_password):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_password.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def full_name_request(message):
                ...
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, full_name_entry, what_full_name)
            ...
            def full_name_entry(message, what_full_name):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_full_name.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def date_of_birth_request(message):
                ...
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, date_of_birth_entry, what_date_of_birth)
            ...
            def date_of_birth_entry(message, what_date_of_birth):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_date_of_birth.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def phone_number_request(message):
                ...
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                what_phone_number = bot.send_message(
                    d2[f'{user_name}']['chat_id'], 'Введите номер телефона:')
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, phone_number_entry, what_phone_number)
            ...
            def phone_number_entry(message, what_phone_number):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_phone_number.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def email_request(message):
                ...
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                what_email = bot.send_message(
                    d2[f'{user_name}']['chat_id'], 'Введите email:')
                while True:
                    try:
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], email_no.message_id)
                        break
                    except BaseException:
                        break
                while True:
                ...
                bot.register_next_step_handler(
                    message, email_entry, what_email)
            ...
            def email_entry(message, what_email):
                if message.text == 'Регистрация':
                    ...
                    if message.text == '/error':
                        ...
                        d2[f'{user_name}'].update(v)
                        with connection.cursor() as cursor:
                            unique_id_local = f"SELECT unique_id FROM login_and_password WHERE email='{
                                email}'"
                            cursor.execute(unique_id_local)
                        try:
                            local_db_1 = (cursor.fetchall()[0])
                            ...
                            while True:
                                try:
                                    ...
                                    bot.delete_message(
                                        d2[f'{user_name}']['chat_id'], message.message_id)
                                    bot.register_next_step_handler(
                                        message, checking_the_code, code)
                                    break
                                except Exception as ex:
                                    print(ex)
                                    global not_db
            ...
            def checking_the_code(message, code):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], code.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
                    ...
                    if str(random_code) == code_from_user:
                        ...
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], message.message_id)
                        email_no = bot.send_message(
                            d2[f'{user_name}']['chat_id'], 'Код неверный\nПереносим вас назад')
                        time.sleep(3)
                        email_request(message)
            ...
            def university_request_full(message, local_5):
                ...
                while True:
                    try:
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], local_5.message_id)
                        break
                    except BaseException:
                        break

                bot.register_next_step_handler(
                    message, university_entry_full, what_university)
            ...
            def university_entry_full(message, what_university):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_university.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def university_request_abbreviation(message):
                ...
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, university_entry_abbreviation, what_university)
            ...
            def university_request_abbreviation_en(message):
                ...
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, university_entry_abbreviation_en, what_university)
            ...
            def university_entry_abbreviation_en(message, what_university):
                ...
                v = {'university_abbreviation_en': f'{
            ...
            def user_status_info(message):
                ...
                bot.delete_message(d2[f'{user_name}']
                                   ['chat_id'], message.message_id)
                bot.register_next_step_handler(
                    message, user_status_info_check, local_message)
            ...
            def user_status_info_check(message, local_message):
                ...
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_message.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
            ...
            def consent_to_processing_request(message):
                ...
                if for_deletion == 'repeat_sending_photo':
                    # user_name = message.from_user.username
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], repeat_sending_photo.message_id)
                    for_deletion = ''
                # user_name = message.from_user.username
            ...
            def consent_to_processing_entry(
                    message, what_consent_to_processing, software_photo):
                user_name = message.from_user.username
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
                if message.text == '/error':
                    ...
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], local_a_message.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], what_consent_to_processing.message_id)
                    bot.delete_message(
                        d2[f'{user_name}']['chat_id'], software_photo.message_id)
                    start(message)
                elif message.text == '/home':
                    local_a_message = bot.send_message(d2[f'{user_name}']['chat_id'],
                                                       'Возвращаю вас в меню авторизации')
                    ...
                    while True:
                        try:
                            global src, binary_photo
                            file_info = bot.get_file(
                                message.photo[len(message.photo) - 1].file_id)
                            downloaded_file = bot.download_file(
                                file_info.file_path)

                            src = 'main.py/' + file_info.file_path
                            ...
                            binary_photo = convert_to_Binary_for_photo(f'{
                                                                       src}')
                    ...
                    try:
                        ...
                        if str(user_name) == 'None':
                            user_name = message.from_user.first_name
                        bot.delete_message(
                            d2[f'{user_name}']['chat_id'], photo_added.message_id)
                    except BaseException:
                        pass
            ...
            def consent_to_processing_check(message):
                if message.text == 'Все верно':
                        ...
                        with connection.cursor() as cursor:
                            ...
                            values_for_registration = (
                                random.randint(0, 1000000), {
                                    d2[f'{user_name}']['login']},
                                {d2[f'{user_name}']['password']},
                                {d2[f'{user_name}']['full_name']}, {
                                    d2[f'{user_name}']['date_of_birth']},
                                {d2[f'{user_name}']['phone_number']}, {
                                    d2[f'{user_name}']['email']},
                                {d2[f'{user_name}']['university_full']},
                                {d2[f'{user_name}']['university_abbreviation']},
                                {d2[f'{user_name}']['university_abbreviation_en']}, {
                                    d2[f'{user_name}']['user_status']},
                                {d2[f'{user_name}']['binary_photo']}, 'Проверка')
                            cursor.execute(
                                insert_querty, values_for_registration)
                            connection.commit()
                    except Exception as ex:
                        print(ex)
                    ...
                    dir = 'main.py/photos'  # Удаление фото
                    for f in os.listdir(dir):
                        os.remove(os.path.join(dir, f))
                    ...
                    while True:
                        try:
                            ...
                            if str(user_name) == 'None':
                                user_name = message.from_user.first_name
                            bot.delete_message(
                                d2[f'{user_name}']['chat_id'], application_sent.message_id)
                            break
                        except BaseException:
                            break
                    ...
                    if str(user_name) == 'None':
                        user_name = message.from_user.first_name
                    bot.send_message(
                        d2[f'{user_name}']['chat_id'], 'Возвращаю вас в меню авторизации')
                    start(message)
                elif message.text == '/home':
                    user_name = message.from_user.username
                    if str(user_name) == 'None':
        ...
        def login_to_account(message, bot):
            ...
            def what_is_the_login(message):
                ...
                what_is_the_login_1 = bot.send_message(
                    message.chat.id, 'Введите логин:')
                v = {'start_message_bool': 'False'}
                user_name = message.from_user.username
                if str(user_name) == 'None':
                    user_name = message.from_user.first_name
            ...
            def what_is_the_password(message):
                ...
                what_is_the_password_1 = bot.send_message(
            ...
            def check(password, message):
                ...
                for i in login:
                    if i == "'":
                        ...
                        time.sleep(3)
                        bot.delete_message(
                            message.chat.id, what_is_the_password_1.id)
                ...
                for i in password:
                    if i == "'":
                        ...
                        start(message)
                with connection.cursor() as cursor:
                    all = f"SELECT password FROM login_and_password WHERE login='{
                        login}'"
                    cursor.execute(all)
                try:
                ...
                if password_from_db == password:
                    tables()
                    with connection.cursor() as cursor:
                        application_status = f"SELECT application_status FROM login_and_password WHERE login='{
                    ...
                    if application_status == 'Проверка':
                        ...
                        try:
                            with connection.cursor() as cursor:
                                com = f"SELECT сomment FROM login_and_password WHERE login='{
                                    login}' and password='{password}'"
                                cursor.execute(com)
                            ...
                            with connection.cursor() as cursor:
                                com = f"DELETE FROM login_and_password WHERE login='{
                                    login}' and password='{password}'"
                                cursor.execute(com)
                                connection.commit()
    ...
    def task2():
        ...
        def main_menu(message):
            ...
            if message_to_delete_to_main_menu_for_moderation == 'Correct_login_or_password_for_moderation':
                ...
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], Correct_login_or_password_for_moderation.message_id)
            ...
            while True:
                try:
                    bot_2.delete_message(
                        d2[f'{user_name}']['chat_id'], text_for_check.message_id)
                    break
                except BaseException:
                    break
            while True:
                try:
                    bot_2.delete_message(
                        d2[f'{user_name}']['chat_id'], application_is_ok.message_id)
                    break
                except BaseException:
                    break
            while True:
                try:
                    bot_2.delete_message(
                        d2[f'{user_name}']['chat_id'], local1.message_id)
                    break
                except BaseException:
                    break
        ...
        def check(message):
            ...
            if message.text == 'Выйти из аккаунта':
                ...
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], main_menu_message_for_moderation.message_id)
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], message.message_id)
                ...
                time.sleep(3)
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], logged_out.message_id)
                start_2(message)
        ...
        def new_registration_applications(message):
            ...
            @bot_2.callback_query_handler(
                func=lambda call: call.data == 'last_order_1')
            def last_order_1(call):
                global kol_for_moder
                if kol_for_moder > 0:
                    kol_for_moder -= 1
                    bot_2.delete_message(
                        d2[f'{user_name}']['chat_id'], main_menu_text_1.message_id)
                    new_registration_applications(message)

            @bot_2.callback_query_handler(
                func=lambda call: call.data == 'next_order_2')
            ...
            @bot_2.callback_query_handler(func=lambda call: call.data ==
                                          'check_applications')
            def check_applications(call):
                global unique_id
                print(f'unique_id - {unique_id}')
                with connection.cursor() as cursor_1:
                    wait_3 = f"SELECT * FROM login_and_password WHERE unique_id = '{
                        unique_id}'"
                    ...
                    while True:
                        ...
                        try:
                            ...
                            loc = bot_2.send_message(
                                d2[f'{user_name}']['chat_id'], 'Новых заявок нет!')
                            time.sleep(3)
                            bot_2.delete_message(
                                d2[f'{user_name}']['chat_id'], loc.message_id)
                            while True:
                                try:
                ...
                def check_applications_2(message):
                    while True:
                        try:
                            global way
                            with connection.cursor() as cursor_1:
                                wait_2 = f"SELECT * FROM login_and_password WHERE unique_id = '{
                                    unique_id}'"
                            ...
                            while True:
                                try:
                                    bot_2.delete_message(
                                        d2[f'{user_name}']['chat_id'], local_for_univercity.message_id)
                                    break
                                except BaseException:
                                    break

                            @bot_2.callback_query_handler(
                                func=lambda call: call.data == 'total_back_from_decision')
                            def total_back_from_decision(call):

                                with connection.cursor() as cursor_1:
                                    wait_1 = f"UPDATE login_and_password SET application_status = 'Проверка' WHERE unique_id = '{
                                        unique_id}'"
                                    cursor_1.execute(wait_1)
                                    connection.commit()
                            ...
                            @bot_2.callback_query_handler(
                                func=lambda call: call.data == 'approve_the_application')
                            def approve_the_application(call):
                                global application_is_ok
                                with connection.cursor() as cursor_1:
                                    wait_1 = f"UPDATE login_and_password SET application_status = 'Одобрено' WHERE unique_id = '{
                                        unique_id}'"
                                    cursor_1.execute(wait_1)
                                    connection.commit()
                                send_ya_mail(recipients_emails=[f'{email}'],
                            ...
                            @bot_2.callback_query_handler(
                                func=lambda call: call.data == 'reject_application')
                            def reject_application(call):
                                def comment_if_application_is_no(message):
                                    while True:
                                        try:
                                            ...
                                            global local1
                                            with connection.cursor() as cursor_1:
                                                wait_1 = f"UPDATE login_and_password SET сomment = '{
                                                    comment}' WHERE unique_id = '{unique_id}'"
                                                cursor_1.execute(wait_1)
                                                connection.commit()
                                            bot_2.delete_message(d2[f'{user_name}']['chat_id'],
                                ...
                                with connection.cursor() as cursor_1:
                                    wait_1 = f"UPDATE login_and_password SET application_status = 'Удалено' WHERE unique_id = '{
                                        unique_id}'"
                                    cursor_1.execute(wait_1)
                                    connection.commit()
                                ...
                                bot_2.delete_message(
                                    d2[f'{user_name}']['chat_id'], text_for_check.message_id)
                                bot_2.register_next_step_handler(
                                    message, comment_if_application_is_no)

                            @bot_2.callback_query_handler(
                                func=lambda call: call.data == 'edit_the_application')
                            def edit_the_application(call):
                                global text_for_check_2

                                @bot_2.callback_query_handler(
                                    func=lambda call: call.data == 'univercity_1')
                                    ...
                                    while True:
                                        try:
                                            ...
                                            def edit_univercity_1(message):
                                                ...
                                                university_full = message.text
                                                with connection.cursor() as cursor_1:
                                                    wait_1 = f"UPDATE login_and_password SET university_full = '{
                                                        university_full}' WHERE unique_id = '{unique_id}'"
                                                    cursor_1.execute(wait_1)
                                                    connection.commit()
                                                bot_2.delete_message(
                                                    d2[f'{user_name}']['chat_id'], message.message_id)
                                ...
                                @bot_2.callback_query_handler(
                                    func=lambda call: call.data == 'univercity_2')
                                    ...
                                    while True:
                                        try:
                                            ...
                                            def edit_univercity_1(message):
                                                ...
                                                university_abbreviation = message.text
                                                with connection.cursor() as cursor_1:
                                                    wait_1 = f"UPDATE login_and_password SET university_abbreviation = '{
                                                        university_abbreviation}' WHERE unique_id = '{unique_id}'"
                                                    cursor_1.execute(wait_1)
                                                    connection.commit()
                                                bot_2.delete_message(
                                                    d2[f'{user_name}']['chat_id'], message.message_id)
                                ...
                                @bot_2.callback_query_handler(
                                    func=lambda call: call.data == 'univercity_3')
                                    ...
                                    while True:
                                        try:
                                            ...
                                            def edit_univercity_1(message):
                                                ...
                                                university_abbreviation_en = message.text
                                                with connection.cursor() as cursor_1:
                                                    wait_1 = f"UPDATE login_and_password SET university_abbreviation_en = '{
                                                        university_abbreviation_en}' WHERE unique_id = '{unique_id}'"
                                                    cursor_1.execute(wait_1)
                                                    connection.commit()
                                                bot_2.delete_message(
                                                    d2[f'{user_name}']['chat_id'], message.message_id)
                                ...
                                def total_back_from_univercity(call):
                                    bot_2.send_message(
                                        d2[f'{user_name}']['chat_id'], 'Возвращаем вас назад')
                                    while True:
                                        try:
                                            bot.delete_message(d2[f'{user_name}']['chat_id'],
                                                               text_for_check_2.message_id)
                            ...
                            for_decision.add(
                                approve_the_application, reject_application)
                            for_decision.add(edit_the_application)
                            for_decision.add(total_back_from_decision)

                            with connection.cursor() as cursor_1:
                                wait_1 = f"UPDATE login_and_password SET application_status = 'Проверяется' WHERE unique_id = '{
                                    unique_id}'"
                                cursor_1.execute(wait_1)
                                connection.commit()
                            ...
                            while True:
                                try:
                                    ...
                                    try:
                                        ...
                                        way = f'main.py/photos' + \
                                            f'/{local_random}'
                                        src = binary_to_file(binary, way)
                                        way = open(way, 'rb')
                                        break
                                    except BaseException:
                                        break
                            while True:
                                try:
                                    bot.delete_message(
                                        d2[f'{user_name}']['chat_id'], text_for_check_2.message_id)
                                    break
                                except BaseException:
                                    break

                            global text_for_check
                            text_for_check = bot_2.send_document(d2[f'{user_name}']['chat_id'], way,
                            ...
                            dir = 'main.py/expert_opinions'  # Удаление соглашений
                            for f in os.listdir(dir):
                                os.remove(os.path.join(dir, f))
                            break
                        except Exception as ex:
            ...
            @bot_2.callback_query_handler(
                func=lambda call: call.data == 'total_back')
            def total_back(call):
            ...
            with connection.cursor() as cursor_1:
                ...
                while True:
                    try:
                        ...
                        while True:
                            try:
                                kol_from_login_and_password = len(
                                    all_for_moderation)
                                break
                            except BaseException:
                                break
                        ...
                        local_random = f'Соглашение на обработку персональных данных {
                            random.randint(0, 10000)}'
                        binary = all_for_moderation['consent']
                        way_2 = f'main.py/photos' + \
                            f'/{local_random}.png'  # Не уверен на счет .png
            ...
            while True:
                try:
                    bot_2.delete_message(
                        d2[f'{user_name}']['chat_id'], transfer_to_the_authorization_menu.message_id)
                    break
                except BaseException:
                    break
            while True:
        ...
        def start_2(message):
            ...
            start_message_for_moderation = bot_2.send_message(
                d2[f'{user_name}']['chat_id'], f'Войдите в аккаунт')
            ...
            if message_to_delete_to_main_menu_for_moderation == 'Correct_login_or_password_for_moderation':
                ...
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], Prohibited_character_for_moderation.message_id)
            elif message_to_delete_to_main_menu_for_moderation == 'Выход из аккаунта':
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], log_out_of_your_account.message_id)
        ...
        def login_to_account(message):
            ...
            def log_in(message):
                ...
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], what_is_the_login_1_for_moderation.id)
                bot_2.delete_message(
                    d2[f'{user_name}']['chat_id'], start_message_for_moderation.message_id)
                what_is_the_password(message)
            ...
            def what_is_the_login(message):
                ...
                what_is_the_login_1_for_moderation = bot_2.send_message(
                    d2[f'{user_name}']['chat_id'], 'Введите логин:')
            ...
            def check(password_for_moderation, message):
                ...
                for i in login_for_moderation:
                    if i == "'":
                        ...
                        time.sleep(3)
                        bot_2.delete_message(
                            d2[f'{user_name}']['chat_id'], what_is_the_password_1_for_moderation.id)
                        bot_2.delete_message(
                            d2[f'{user_name}']['chat_id'], message.id)
                ...
                for i in password_for_moderation:
                    if i == "'":
                        ...
                        start_2(message)
                with connection.cursor() as cursor:
                    all = f"SELECT password FROM login_and_password_for_moderation WHERE login='{
                        login_for_moderation}'"
                    cursor.execute(all)
                try:
    ...
    # Потоки программы для запуска и поддержки ботов(Пользователя, Модерации,
    # Проверяющих)
